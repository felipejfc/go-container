...
func child() {
	...
	must(syscall.Mount("proc", "./alpine/proc", "proc", syscall.MS_NOEXEC|syscall.MS_NOSUID|syscall.MS_NODEV, ""))
	must(syscall.Mount("tmp", "./alpine/tmp", "tmpfs", syscall.MS_NOSUID|syscall.MS_STRICTATIME, "mode=755"))
